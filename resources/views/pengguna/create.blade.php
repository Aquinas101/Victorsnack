...
<div class="container mx-auto max-w-4xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800">
            <i class="fas fa-user-plus text-red-600 mr-2"></i>Tambah Pengguna Baru
        </h1>
        <p class="text-gray-600 mt-1">Lengkapi form untuk menambahkan pengguna baru</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4">
            <h2 class="text-xl font-semibold text-white">
                <i class="fas fa-edit mr-2"></i>Form Tambah Pengguna
            </h2>
        </div>

        <form action="{{ route(role_route('pengguna.store')) }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="mt-2 text-xs text-gray-500">
                    <i class="fas fa-info-circle mr-1"></i>Username untuk login (harus unik)
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-semibold text-gray-700 mb-2">
                        <i class="fas fa-lock text-red-600 mr-1"></i>Konfirmasi Password
                        <span class="text-red-500">*</span>
                    </label>
                    <input type="password" 
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <label class="relative flex flex-col items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-yellow-500 transition duration-200">
                        <input type="radio" name="role" value="pemilik" class="sr-only peer" {{ old('role') == 'pemilik' ? 'checked' : '' }} required>
                    ...
                    <label class="relative flex flex-col items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition duration-200">
                        <input type="radio" name="role" value="karyawan" class="sr-only peer" {{ old('role') == 'karyawan' ? 'checked' : '' }} required>
                    ...
                    <label class="relative flex flex-col items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-green-500 transition duration-200">
                        <input type="radio" name="role" value="kasir" class="sr-only peer" {{ old('role') == 'kasir' ? 'checked' : '' }} required>
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700 font-medium">Informasi Role</p>
                        <ul class="text-sm text-blue-600 mt-2 space-y-1">
                            <li><strong>Pemilik:</strong> Akses laporan, analisis bisnis & kelola pengguna</li>
                            <li><strong>Karyawan:</strong> Kelola produk, varian & stok</li>
                            <li><strong>Kasir:</strong> Akses kasir & lihat transaksi sendiri</li>
                        </ul>
                    </div>
                </div>
            </div>
