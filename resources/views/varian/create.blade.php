...
<div class="container mx-auto max-w-4xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800">
            <i class="fas fa-plus-circle text-red-600 mr-2"></i>Tambah Varian Produk
        </h1>
        <p class="text-gray-600 mt-1">Lengkapi form untuk menambahkan varian produk (berat & harga)</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4">
            <h2 class="text-xl font-semibold text-white">
                <i class="fas fa-edit mr-2"></i>Form Tambah Varian
            </h2>
        </div>

        <form action="{{ route(role_route('varian.store')) }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <p class="mt-2 text-xs text-gray-500">
                    <i class="fas fa-info-circle mr-1"></i>Pilih produk yang akan ditambahkan variannya
                </p>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-blue-600 mt-1">
                            Satu produk bisa memiliki banyak varian. Contoh: Chitato 68g (Rp 10.000), Chitato 100g (Rp 15.000), Chitato 150g (Rp 20.000)
                        </p>
                    </div>
                </div>
            </div>
