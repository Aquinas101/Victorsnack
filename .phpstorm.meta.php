...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\victorsnack\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\victorsnack\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','midtrans.server_key',
'midtrans.client_key','midtrans.merchant_id','midtrans.is_production','midtrans.is_sanitized','midtrans.is_3ds',
...
'web','api',);
        registerArgumentsSet('routes', 'login','login.post','logout','midtrans.notification',
'admin.dashboard','admin.profile','admin.profile.update','admin.password.change','admin.password.update',
'admin.produk.index','admin.produk.create','admin.produk.store','admin.produk.show','admin.produk.edit',
'admin.produk.update','admin.produk.destroy','admin.varian.index','admin.varian.create','admin.varian.store',
'admin.varian.show','admin.varian.edit','admin.varian.update','admin.varian.destroy','admin.stok.index',
'admin.stok.create','admin.stok.store','admin.stok.show','admin.stok.edit','admin.stok.update',
'admin.stok.destroy','admin.transaksi.index','admin.transaksi.store','admin.transaksi.show','admin.transaksi.update',
'admin.transaksi.destroy','admin.transaksi.cetak','admin.pengguna.index','admin.pengguna.create','admin.pengguna.store',
'admin.pengguna.show','admin.pengguna.edit','admin.pengguna.update','admin.pengguna.destroy','admin.pengguna.reset-password',
'admin.laporan.penjualan','admin.laporan.keuangan','admin.laporan.analisis','admin.laporan.admin','admin.laporan.penjualan.pdf',
'admin.laporan.keuangan.pdf','karyawan.dashboard','karyawan.profile','karyawan.profile.update','karyawan.password.change',
'karyawan.password.update','karyawan.produk.index','karyawan.produk.create','karyawan.produk.store','karyawan.produk.show',
'karyawan.produk.edit','karyawan.produk.update','karyawan.produk.destroy','karyawan.varian.index','karyawan.varian.create',
'karyawan.varian.store','karyawan.varian.show','karyawan.varian.edit','karyawan.varian.update','karyawan.varian.destroy',
'karyawan.stok.index','karyawan.stok.create','karyawan.stok.store','karyawan.stok.show','karyawan.stok.edit',
'karyawan.stok.update','karyawan.stok.destroy','karyawan.transaksi.index','karyawan.transaksi.show','karyawan.transaksi.cetak',
'kasir.dashboard','kasir.profile','kasir.profile.update','kasir.password.change','kasir.password.update',
'kasir.index','kasir.proses','kasir.create-token','kasir.process-payment','kasir.payment-finish',
'kasir.varian','kasir.stok','kasir.transaksi.saya','kasir.riwayat.index','kasir.transaksi.detail',
'kasir.transaksi.cetak','kasir.produk.index','storage.local',);
        registerArgumentsSet('views', 
'auth.login','components.footer','components.header','components.sidebar','dashboard.admin',
'dashboard.karyawan','dashboard.kasir','kasir.index','kasir.riwayat','kasir.transaksi-saya',
'laporan.analisis','laporan.keuangan','laporan.penjualan','layouts.app','pemilik.analisis-bisnis',
'pemilik.laporan-keuangan','pemilik.laporan-penjualan','pengguna.change-password','pengguna.create','pengguna.edit',
'pengguna.index','pengguna.profile','produk.create','produk.edit','produk.index',
'stok.create','stok.edit','stok.index','transaksi.detail','transaksi.index',
'transaksi.struk','varian.create','varian.edit','varian.index','welcome',
...
'MIDTRANS_SERVER_KEY','MIDTRANS_CLIENT_KEY','MIDTRANS_MERCHANT_ID','MIDTRANS_IS_PRODUCTION','MIDTRANS_IS_SANITIZED',
'MIDTRANS_IS_3DS','MAIL_MAILER','MAIL_SCHEME','MAIL_HOST','MAIL_PORT',
